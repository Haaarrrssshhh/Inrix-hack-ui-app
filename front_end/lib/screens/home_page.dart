...
import 'package:inrix_hack/screens/coordinate.dart';
...
class _MyHomePageState extends State<HomePage> {
  ...
  final String key = "AIzaSyD6oe-oQ00vrrw5c8bPYcc2g0i1jdTbf6E";
  LatLng _center =
      LatLng(45.4654219, 9.1859243); //milan coordinates -- default location
  GoogleMapsPlaces _places =
      GoogleMapsPlaces(apiKey: "AIzaSyD6oe-oQ00vrrw5c8bPYcc2g0i1jdTbf6E");
  GoogleMapPolyline googleMapPolyline =
      new GoogleMapPolyline(apiKey: "AIzaSyD6oe-oQ00vrrw5c8bPYcc2g0i1jdTbf6E");
  ...
  computePath() async {
    ...
    // Iterable coordinate = await googleMapPolyline.getCoordinatesWithLocation(
    //     origin: origin, destination: end, mode: RouteMode.driving) as Iterable;
